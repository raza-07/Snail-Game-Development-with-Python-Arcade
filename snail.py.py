...
back = arcade.load_texture("pic6.jpg")
...
class Game(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        if self.state == "GameMenu":
            arcade.draw_text("Welcome to Snail game", 100, 300, arcade.color.BLACK, font_size=28)
            arcade.draw_text("Press any key to continue", 480, 250, arcade.color.BLACK, font_size=30, anchor_x="center")
            self.__init__()
            ...
            arcade.draw_text("Snail Game", 630, 515, arcade.color.BLACK, font_size=18)
            ...
            arcade.draw_text(" Shahzaib Gill " , 690, 240,font_size=18)
            ...
            if self.win == "human1":
                arcade.draw_text("Congratulations, Human has Won !", 100, 300, arcade.color.BLACK, font_size=35)
                arcade.draw_text("Click to continue", 480, 250, arcade.color.BLACK, font_size=30, anchor_x="center")
              

            elif self.win == "BOT":
                arcade.draw_text("Congratulation BOT has Won :)", 100, 300, arcade.color.BLACK, font_size=35)
                arcade.draw_text("Click to continue", 480, 250, arcade.color.BLACK, font_size=20, anchor_x="center")
            

            elif self.win == "draw":
                arcade.draw_text("It's a draw..", 350, 300, arcade.color.BLACK, font_size=35)
                arcade.draw_text("Click to continue", 480, 250, arcade.color.BLACK, font_size=30, anchor_x="center")
    ...
    #Function to check if we are stuckb
